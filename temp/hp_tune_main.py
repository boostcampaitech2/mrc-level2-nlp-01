...
def main():
    args = {
        ...
        "project": {
            "name": "hyper_parameter_sample",
            "base_path": "/home/ubuntu/workspace/mrc-level2-nlp-01/models",
        },
        "model": {"name": "klue/roberta-small"},
        "data": {
    ...
    undefined = object()
    cfg = DefaultMunch.fromDict(args, undefined)
    hp_optimizer(cfg.project, cfg.model, cfg.data, cfg.train)
...
def hp_optimizer(project_args, model_args, dataset_args, train_args):
    ...
    training_args = TrainingArguments(
        "/home/ubuntu/workspace/mrc-level2-nlp-01/raytest",
        evaluation_strategy="steps",
        eval_steps=500,
        disable_tqdm=True,
    )
